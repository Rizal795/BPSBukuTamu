    ...
    <div class="ibox">
        <div class="ibox-head">
            ...
            <div class="btn-group m-b-10">
                ...
                <a href="{{ route('cetak.pegawai') }}" class="btn btn-danger btn-sm"><i class="fa fa-solid fa-download"></i> Dwonload PDF</a>
                <a href="{{ route('export.exel') }}" class="btn btn-success btn-sm"><i class="fa fa-solid fa-download"></i> Dwonload Excel</a>
